    ...
    public function update()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            if($this->input->post('lstatus')=="Ready to upload")            
            {
                ...
                if($this->input->post('sell_as')== 'Sealed' || $this->input->post('sell_as')== 'New' )
                {   
                    if((($this->input->post('category_id') == 5 || $this->input->post('category_id') == 9) && (substr($this->input->post('sku'),2,1) != 'N') )
                        || ($this->input->post('category_id') != 5 && $this->input->post('category_id') != 9 && (substr($this->input->post('sku'),1,1) != 'N')))
                    {
                ...
                {
                    if((($this->input->post('category_id') == 5 || $this->input->post('category_id') == 9) && (substr($this->input->post('sell_as'),0,1) != substr($this->input->post('sku'),2,1)) )
                        || ($this->input->post('category_id') != 5 && $this->input->post('category_id') != 9 && (substr($this->input->post('sell_as'),0,1) != substr($this->input->post('sku'),1,1))))
                    {
                            $this->session->set_flashdata('flash_message', 'update_sku');
                            redirect('admin/products/update/'.$id.'');
